...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return android.preference.PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || LocNotifyPreference.class.getName().equals(fragmentName);
    }
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class LocNotifyPreference extends android.preference.PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_data_sync);
            setHasOptionsMenu(true);
            bindPreferenceSummaryToValue2(findPreference("switch_notify2"));

            bindPreferenceSummaryToValue(findPreference("notify_voltage"));
        }
